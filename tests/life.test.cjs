...
function pkg() {return {version:1,id:'page-1',date:'2026-09-17',text:'Walked 20 minutes.',records:[{title:'Walk',domain:'Movement',kind:'activity',completed:true,minutes:20,evidence:'Walked 20 minutes.'}]};}
